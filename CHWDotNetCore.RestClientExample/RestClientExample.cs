...
using RestSharp;
namespace CHWDotNetCore.ConsoleAppRestClientExample
{
    internal class RestClientExample
    {
        //private readonly HttpClient client = new HttpClient() { BaseAddress = new Uri("https://localhost:7160") };
        private readonly RestClient _client = new RestClient(new Uri("https://localhost:7160"));
        ...
        public async Task RunAsync()
        {
            ...
            //await UpdateAsync(1, "title 111", "author 2", "content 3");
            //await EditAsync(1);
        }
